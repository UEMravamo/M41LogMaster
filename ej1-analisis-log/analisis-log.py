...
def analisis_log(input_file, init_datetime, end_datetime, hostname):
    ...
    init_timestamp, end_timestamp = convertir_fechas(init_datetime, end_datetime, input_format)

    df_filtered = filtrar_datos_por_tiempo(df_log_csv, init_timestamp, end_timestamp)
